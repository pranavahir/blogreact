...
const RegisterForm = (props) => {
    ...
    const Register = (e) => {
        ...
        axios({
            method: "POST",
            url: `${process.env.REACT_APP_NODE_API_URL}/register`,
    ...
    return (
        <div className="d-flex justify-content-center align-items-center" style={{ height: '100vh' }}>
            <form style={{ width: '400px' }}>
                <h2 className="mb-3">Blog Application Register</h2>
                <div className="mb-3">
                ...
                <div className="row mt-3">
                    <div className="col">
                        <p className="mb-0">Already have an account?<button type="button" className="btn btn-link p-1 mb-1" onClick={() => props.setLoginPage(true)}>Login</button></p>
                    </div>
                </div>
            </form>
        </div>
